...
public partial class FileSystemContextBatch : DbContext
{
    public FileSystemContextBatch()
    {
    }

    public FileSystemContextBatch(DbContextOptions<FileSystemContext> options)
        : base(options)
    {
    }
